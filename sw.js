// TypeFill Service Worker v4.2.0
// FORCE UPDATE - This version number change triggers app update
// Version: 4.2.0
// Feature: Privacy Masking for sensitive data + Web Share API export
// Last Updated: 2025-01-10

const CACHE_NAME = 'typefill-v4.2.0';
const RUNTIME_CACHE = 'typefill-runtime-v4.2.0';
const VERSION = '4.2.0';
