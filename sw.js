// TypeFill Pro Service Worker v6.0.0
// FORCE UPDATE - Version bump triggers immediate cache refresh
// Version: 6.0.0
// Feature: TypeFill Pro - Lock/Unlock Editor, Quick Actions, Folder Sorting, Sub-Folders
// Last Updated: 2025-01-11
// FIX: Network-first strategy for HTML to ensure updates are applied immediately

const CACHE_NAME = 'typefill-pro-v6.0.0';
const RUNTIME_CACHE = 'typefill-pro-runtime-v6.0.0';
const VERSION = '6.0.0';
...
self.addEventListener('fetch', (event) => {
    ...
    // For JavaScript files: NETWORK-FIRST to ensure updates
